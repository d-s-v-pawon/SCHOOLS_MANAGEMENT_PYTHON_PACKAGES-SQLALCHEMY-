...
class STANDARDS:                                #Creating the class named standards
    ...
    def cls_students(self):             #A standard object specifies the students of the specified standard using this method
        ...
        class standard(Base):
            ...
            __tablename__ = f"CLASS_{self.name}"
            ...
            ROLL_NUMBERS = Column(Integer,primary_key=True,nullable=False)
        ...
        for i in self.stu_list:
            stu = standard(NAMES = i.name , GENDERS = i.gender , AGES = i.age , SCHOOL_NAMES = i.sch_name , STANDARDS = i.standard , SECTIONS = i.section , ROLL_NUMBERS = i.r_no , CONTACT_NUMBERS = i.c_no , PERCENTAGES = i.percent)
            session.add(stu)
