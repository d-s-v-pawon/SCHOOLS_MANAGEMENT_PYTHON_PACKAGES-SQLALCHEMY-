...
class STUDENTS:                                 #Create a class named STUDENTS
    ...
    def __init__(self,name,gender,age,sch_name,standard,section,r_no,c_no,percent):         #The __init__ constructor is used for taking the students details as instance variables of each individual student
        ...
        students = Base.classes.STUDENTS_DETAILS
        ...
        stu =students(NAMES = self.name,GENDERS = self.gender,AGES = self.age,SCHOOL_NAMES = self.sch_name,STANDARDS = self.standard,SECTIONS = self.section,ROLL_NUMBERS = self.r_no,CONTACT_NUMBERS = self.c_no,PERCENTAGES = self.percent)
